        ...
        <section id="skills" className="section py-20 px-6 bg-gray-100">
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-orange-500" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/>
                        </svg>
                        <h3 className="text-xl font-semibold mb-2">HTML & CSS</h3>
                        <p className="text-gray-600 text-center">Semantic markup and stylish, responsive designs.</p>
                    </div>
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-yellow-500" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <p className="text-gray-600 text-center">Interactive front-end experiences and complex logic.</p>
                    </div>
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <p className="text-gray-600 text-center">Building robust and scalable user interfaces.</p>
                    </div>
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-green-500" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <p className="text-gray-600 text-center">Backend development and RESTful APIs.</p>
                    </div>
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05-.05-1.23.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.26-.02.21-.01h5.84l.69-.05.59-.14.5-.21.41-.28.33-.32.27-.35.2-.36.15-.36.1-.35.07-.32.04-.28.02-.21V6.07h2.09l.14.01zm-6.47 14.25c-.28 0-.52-.09-.73-.26-.21-.17-.32-.38-.32-.64 0-.25.11-.46.32-.63.21-.17.45-.26.73-.26.28 0 .52.09.73.26.21.17.32.38.32.63 0 .26-.11.47-.32.64-.21.17-.45.26-.73.26zm6.36 0c-.28 0-.52-.09-.73-.26-.21-.17-.32-.38-.32-.64 0-.25.11-.46.32-.63.21-.17.45-.26.73-.26.28 0 .52.09.73.26.21.17.32.38.32.63 0 .26-.11.47-.32.64-.21.17-.45.26-.73.26z"/>
                        </svg>
                        <h3 className="text-xl font-semibold mb-2">Python</h3>
                        <p className="text-gray-600 text-center">Data processing and server-side scripting.</p>
                    </div>
                    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg transform transition-transform hover:scale-105">
                        <svg className="h-16 w-16 mb-4 text-gray-700" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <p className="text-gray-600 text-center">Managing and optimizing relational and NoSQL databases.</p>
                    </div>
                </div>
            </div>
        </section>
